...
public val ToDoIcons.LowPriority: ImageVector
    get() {
        if (_lowPriority != null) {
            return _lowPriority!!
        }
        _lowPriority = Builder(name = "LowPriority", defaultWidth = 200.0.dp, defaultHeight =
                200.0.dp, viewportWidth = 1024.0f, viewportHeight = 1024.0f).apply {
            path(fill = SolidColor(Color(0xFF1296db)), stroke = null, strokeLineWidth = 0.0f,
                ...
                curveToRelative(0.0f, 14.64f, 11.26f, 26.52f, 25.14f, 26.52f)
                arcToRelative(25.6f, 25.6f, 0.0f, false, false, 24.78f, -21.76f)
                lineToRelative(0.41f, -4.76f)
                arcToRelative(25.86f, 25.86f, 0.0f, false, false, -25.19f, -26.52f)
                close()
                moveTo(514.3f, 307.2f)
